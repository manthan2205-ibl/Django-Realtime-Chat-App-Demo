...
class Room(models.Model):
  user = models.ForeignKey(Chat_User, related_name="room_user", on_delete=models.CASCADE)
...
class Participants(models.Model):
  ...
  users = models.ManyToManyField(Chat_User, related_name="participants_user", blank=True)
...
class Messages(models.Model):
  ...
  user = models.ForeignKey(Chat_User, related_name="messages_user", on_delete=models.CASCADE)
  ...
  def __str__(self):
    return str(self.room) + '  ' + str(self.message) + '  ' + str(self.id)